...
const AboutPage4 = () => {
  return (
    <div className='subpage-about'>
      ...
      <p>
        This responsive single page app demonstates much of what I have learned so far. It utilizes vw and vh style units in an attempt to have a consistent look and feel across all screen sizes.
      </p>
